// Argus pilot analytics — PostHog EU cloud
// Identifies the real user via Cloudflare Access header (server-side → /api/current-user)
// Skips entirely on localhost so dev traffic never pollutes pilot data
if (window.location.hostname === 'argus.auroraer.cloud') {
  ...
  posthog.init('phc_sxiAFjjrjHUA286RsugsQjjfZKpUssoyUaaoMa3YCneW', {
